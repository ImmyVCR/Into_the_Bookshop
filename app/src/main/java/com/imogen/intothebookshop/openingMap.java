...
public class openingMap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opening_map);

        windowOption = findViewById(R.id.windows);
        streetOption = findViewById(R.id.street);
        phoneOption = findViewById(R.id.phone);
